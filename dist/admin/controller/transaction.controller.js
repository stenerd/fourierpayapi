...
let AdminTransactionController = class AdminTransactionController extends controller_core_1.CoreController {
    constructor(adminTransactionService) {
        super();
        this.adminTransactionService = adminTransactionService;
    }
    async transactions(res, query) {
...
], AdminTransactionController.prototype, "transactions", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, view_transaction_dto_1.ViewTransactionDto]),
    __metadata("design:returntype", Promise)
], AdminTransactionController.prototype, "charges", null);
__decorate([
    (0, common_1.Get)('charges/count'),
    __param(0, (0, common_1.Res)({ passthrough: true })),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, view_transaction_dto_1.ViewTransactionDto]),
