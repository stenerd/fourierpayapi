...
let LecturerRepository = class LecturerRepository extends repository_core_1.CoreRepository {
    constructor(lecturerModel) {
        super(lecturerModel);
    }
};
LecturerRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(lecturer_model_1.Lecturer.name)),
