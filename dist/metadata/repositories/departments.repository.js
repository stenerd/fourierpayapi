...
let DepartmentRepository = class DepartmentRepository extends repository_core_1.CoreRepository {
...
DepartmentRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(metadata_model_1.Department.name)),
