...
let FacultyRepository = class FacultyRepository extends repository_core_1.CoreRepository {
...
FacultyRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(metadata_model_1.Faculty.name)),
