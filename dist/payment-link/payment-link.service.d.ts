...
export declare class PaymentLinkService extends CoreService<PaymentLinkRepository> {
    ...
    constructor(paymentLinkRepository: PaymentLinkRepository, payerSheetRepository: PayerSheetRepository, paymentLinkFactory: PaymentLinkFactory, linkService: LinkService, configService: ConfigService, excelService: ExcelService, cloudinaryService: CloudinaryService);
